const adult = (prefix, ownerName, botName, pushname, reqXp, uangku) => {
        return `
╔══✪〘 Informações 〙✪════
║
║───────⊹⊱✫⊰⊹──────
...
║───────⊹⊱✫⊰⊹──────
║➩ ❍ *${prefix}nsfwtrap*
║➩ *Desc* : Envia uma Imagem de NSFW trap aleatória
║───────⊹⊱✫⊰⊹──────
║➩ ❍ *${prefix}nsfwneko*
║➩ *Desc* : Envia uma Imagem de NSFW neko aleatória (FBI FBI OPEN THE DOOR!!!)
║───────⊹⊱✫⊰⊹──────
